...
class Transaction(Base):
    ...
    account_id = Column(Integer, ForeignKey("bank_accounts.id"), nullable=True, comment="ID da conta bancária associada")
    ...
    wallet = relationship("Wallet", back_populates="transactions", comment="Relacionamento com a carteira")
    type = relationship("TransactionType", back_populates="transactions", comment="Relacionamento com o tipo de transação")
    account = relationship("BankAccount", comment="Relacionamento opcional com a conta bancária")
